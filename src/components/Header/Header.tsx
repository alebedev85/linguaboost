...
import { setActiveTab, ActiveTabType } from '@/store/slices/uiSlice';
...
export default function Header() {
  ...
  const currentProfile = useAppSelector((state) => state.dictionary.currentProfile || 'Основной профиль');
      ...
      <div className={styles.container}>
        ...
        <div className={styles.logoSection}>
          ...
          <div>
            ...
            <p className={styles.logoSubtitle}>Умный тренажер английского языка</p>
          </div>
        </div>
